...
<div className="container py-5">
  <h4 className="text-center fw-bold mb-2">Как решать задачи на WorkTap?</h4>
  <p className="text-center text-muted mb-5">Идеально подходит для бизнеса и частных лиц</p>
